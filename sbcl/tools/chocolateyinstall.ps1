...
$packageArgs = @{
  ...
  fileType      = 'MSI'
  url           = 'http://prdownloads.sourceforge.net/sbcl/sbcl-2.6.2-x86-64-windows-binary.msi'
  softwareName  = 'Steel Bank Common Lisp*'
  checksum      = '974848ce053d10d25ad4c4668fd1b9241abed3843dfe8d0c9aa07876ca401584'
  checksumType  = 'sha256'
