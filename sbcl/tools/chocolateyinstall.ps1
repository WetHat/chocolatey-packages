...
$packageArgs = @{
  ...
  fileType      = 'MSI'
  url           = 'http://prdownloads.sourceforge.net/sbcl/sbcl-2.5.3-x86-64-windows-binary.msi'
  softwareName  = 'Steel Bank Common Lisp*'
  checksum      = '3c97fe6485c13ceb2ccbd50a802817663ce206a210e08a755286f50bc1422cdb'
  checksumType  = 'sha256'
