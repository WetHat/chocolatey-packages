...
$packageArgs = @{
  ...
  fileType      = 'MSI'
  url           = 'http://prdownloads.sourceforge.net/sbcl/sbcl-2.4.11-x86-64-windows-binary.msi'
  softwareName  = 'Steel Bank Common Lisp*'
  checksum      = 'd4dcf22effa65ed04c38fcaba1125b2090abc0e5e4f2ffca69bb9185df624444'
  checksumType  = 'sha256'
