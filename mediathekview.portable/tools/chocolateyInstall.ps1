$packageID           = 'mediathekview.portable.11' # includes version as download url is version neutral
$url                 = 'http://netix.dl.sourceforge.net/project/zdfmediathk/Mediathek/Mediathek%2011/MediathekView_11.zip' # download url
