$packageName         = 'autoruns.portable' # arbitrary name for the package, used in messages
$url                 = 'http://download.sysinternals.com/files/Autoruns.zip' # download url
